// Headless smoke test: simulates the OpenClaw gateway loading the plugin entry
// and dispatching a webhook POST. Prints a JSON report to stdout.
//
// Run: node --import tsx scripts/load-smoke.ts
