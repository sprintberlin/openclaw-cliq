...
- [`$NAME` / `${NAME}` env shorthands must be coerced before `resolveSecretInputString`](132-env-shorthand-must-be-coerced-before-resolve.md)  — files: src/secret-resolve.ts,src/security-audit.ts · apis: coerceSecretRef,resolveSecretInputString  — files: src/setup-wizard.ts,src/setup-report.ts · apis: ChannelSetupWizard.credentials,runSingleChannelSecretStep,promptSecretRefForSetup,finalize
