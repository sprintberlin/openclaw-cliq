...
- [Cliq organization identity is not a signed tenant boundary](119-cliq-organization-identity-is-not-a-signed-tenant-boundary.md)  — files: src/identity.ts,src/inbound.ts,src/welcome.ts,src/trusted-org.ts · apis: user.organization_id,/api/v2/users,x-cliq-webhook-secret
